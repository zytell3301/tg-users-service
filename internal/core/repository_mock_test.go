...
func (m *MockUsersRepository) RecordSecurityCode(phone, code string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecordSecurityCode", phone, code)
	ret0, _ := ret[0].(error)
	return ret0
}

// RecordSecurityCode indicates an expected call of RecordSecurityCode.
func (mr *MockUsersRepositoryMockRecorder) RecordSecurityCode(phone, code interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecordSecurityCode", reflect.TypeOf((*MockUsersRepository)(nil).RecordSecurityCode), phone, code)
}
